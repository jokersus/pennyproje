...
module.exports.run = async (bot, message, args) => {
  ...
  if(!args[0] || isNaN(args[1])){
    ...
    .setColor(purple)
    .setTitle("Prices")
    .addField("🌲Wood", "3 Pennies Each")
    .addField("⛏Ore", "7 Pennies Each")
    //.addField("🍖Meat", "9 Coins Each")
    .addField("Grim Post", "5 Pennies Each");
  ...
  let sellembed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setTitle("Sold Grim Post!!")
  .setColor(purple)
  .addField("Amount Sold", number, true)
  .addField("<:INTSL_Penny_heads:479310881789050881> Pennies Gained", price, true);
  ...
  if(args[0] === "ore"){
    ...
    .setColor(purple)
    .addField("⛏Amount Sold", number, true)
    .addField("<:INTSL_Penny_heads:479310881789050881> Pennies Gained", ore_price, true);
  ...
  if(args[0] === "wood"){
    ...
    .setColor(purple)
    .addField("🌲Amount Sold", number, true)
    .addField("<:INTSL_Penny_heads:479310881789050881> Pennies Gained", wood_price, true);
  ...
  if(args[0] === "meat"){
    ...
    .setColor(purple)
    .addField("🍖Amount Sold", number, true)
    .addField("<:INTSL_Penny_heads:479310881789050881> Pennies Gained", meat_price, true);
